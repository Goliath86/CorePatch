//BIS_Effects_Rocket=compile preprocessFileLineNumbers "rocket.sqf";
...
_p = getpos _sh;
	...
	_col = [[0.7,0.7,0.7,0],[0.7,0.7,0.7,0.6],[0.7,0.7,0.7,0.4],[0.8,0.8,0.8,0.3],[0.9,0.9,0.9,0.1], [1,1,1,0]];
_i=1;
_no=6+random 3;
while {_i<_no}
do
	{
	drop [["\ca\Data\ParticleEffects\Universal\Universal", 16, 7, 48], "", "Billboard", 1, 2.5, [0, -0.5, 0],
